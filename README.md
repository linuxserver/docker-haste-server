...
* Update the image: `docker pull linuxserver/chevereto`
...
* Start the new container: `docker start chevereto`
...
docker build \
  --no-cache \
  --pull \
  -t linuxserver/chevereto:latest .
```
